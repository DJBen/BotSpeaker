...
struct OrchestratedMeetingTemplate: Identifiable, Hashable {
    ...
    static let launchReadiness = OrchestratedMeetingTemplate(
        ...
        detail: "4 speakers · expressive launch decision",
    ...
    static let apiIncidentReview = OrchestratedMeetingTemplate(
        ...
        detail: "3 speakers · expressive retrospective",
    ...
    static let performanceReviewOneOnOne = OrchestratedMeetingTemplate(
        id: "performance-review-one-on-one",
        title: "Performance review 1:1",
        detail: "2 speakers · candid feedback and growth",
        speakerRoles: ["Engineering Manager", "Senior Software Engineer"],
        defaultVoiceGenders: ["female", "male"],
